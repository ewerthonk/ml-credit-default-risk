...
def run_preprocessing_pipeline(
    ...
    X_valid_transformed.to_csv(processed_data_directory / "X_valid_transformed.csv", index=False)
...
def create_classifiers_dataset(
    ...
    df_classifiers['classifiers'] = df_classifiers['classifiers'].map(lambda x: re.search(regex, str(x)).group())
